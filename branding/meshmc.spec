...
BuildRequires:    rust
BuildRequires:    cargo
BuildRequires:    pkgconfig(gpg-error) >= 1.36
...
%prep
%autosetup -n MeshMC-%{version} -p1

%build

cd "%{_builddir}/MeshMC-%{version}"
...
%cmake -G Ninja \
    ...
    -D MeshMC_PLUGINS=ON \
    -D MeshMC_UNLEASH_APP_NAME="Linux Native" \
