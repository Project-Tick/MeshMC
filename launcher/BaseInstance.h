...
public:
    ...
    /***
     * the instance has been invalidated - it is no longer tracked by MeshMC for some reason,
    ...
    /// The instance's ID. The ID SHALL be determined by MESHMC internally. The ID IS guaranteed to
    /// be unique.
