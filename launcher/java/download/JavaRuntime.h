...
struct RuntimeVersion {
    ...
    QString toString() const {
        if (build > 0)
            return QString("%1.%2.%3+%4").arg(major).arg(minor).arg(security).arg(build);
...
inline QList<JavaVersionInfo> parseVersionIndex(const QJsonObject &obj, const QString &uid) {
