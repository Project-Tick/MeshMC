# What is this?
A simple Ubuntu package for MeshMC that contains a script that downloads and installs real MeshMC on Ubuntu based systems.
...
# How to build this?
You need dpkg utils. Rename the `meshmc` folder to `meshmc_1.6-1` and then run:
```
fakeroot dpkg-deb --build meshmc_1.6-1
```
