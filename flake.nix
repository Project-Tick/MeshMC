{
  ...
  inputs = {
    ...
    classparser = {
      url = "git+https://projecttick.org/project-tick/projects/classparser";
      flake = false;
    };
    project-tick-cmark = {
      url = "git+https://projecttick.org/project-tick/projects/cmark";
      flake = false;
    };
    ganalytics = {
      url = "git+https://projecttick.org/project-tick/projects/ganalytics";
      flake = false;
    };
    genqrcode = {
      url = "git+https://projecttick.org/project-tick/projects/genqrcode";
      flake = false;
    };
    iconfix = {
      url = "git+https://projecttick.org/project-tick/projects/iconfix";
      flake = false;
    };
    javacheck = {
      url = "git+https://projecttick.org/project-tick/projects/javacheck";
      flake = false;
    };
    javalauncher = {
      url = "git+https://projecttick.org/project-tick/projects/javalauncher";
      flake = false;
    };
    katabasis = {
      url = "git+https://projecttick.org/project-tick/projects/katabasis";
      flake = false;
    };
    libnbtplusplus = {
      url = "git+https://projecttick.org/project-tick/projects/libnbtplusplus";
      flake = false;
    };
    localpeer = {
      url = "git+https://projecttick.org/project-tick/projects/localpeer";
      flake = false;
    };
    neozip = {
      url = "git+https://projecttick.org/project-tick/projects/neozip";
      flake = false;
    };
    optional-bare = {
      url = "git+https://projecttick.org/project-tick/projects/optional-bare";
      flake = false;
    };
    rainbow = {
      url = "git+https://projecttick.org/project-tick/projects/rainbow";
      flake = false;
    };
    systeminfo = {
      url = "git+https://projecttick.org/project-tick/projects/systeminfo";
      flake = false;
    };
    project-tick-tomlplusplus = {
      url = "git+https://projecttick.org/project-tick/projects/tomlplusplus";
      flake = false;
    };
    xz-embedded = {
      url = "git+https://projecttick.org/project-tick/projects/xz-embedded";
      flake = false;
    };
  };
