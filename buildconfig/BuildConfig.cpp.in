...
Config::Config()
{
	...
	UPDATER_GITHUB_REPO = "@MeshMC_UPDATER_GITHUB_REPO@";
	UPDATE_CHANNEL = "@MeshMC_UPDATE_CHANNEL_EFFECTIVE@";
	...
	UPDATER_ENABLED =
		!UPDATER_GITHUB_REPO.isEmpty() && !BUILD_ARTIFACT.isEmpty();
	...
	PATREON_URL = "@MeshMC_Patreon_Url@";
